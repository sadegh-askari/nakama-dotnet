...
namespace Nakama.Tests.Socket
{
    public class WebSocketPartyTest
    {
        ...
        public async Task ShouldCreateAndJoinParty(TestAdapterFactory adapterFactory)
        {
        ...
        [Theory]
        [ClassData(typeof(WebSocketTestData))]
        public async Task ShouldAddAndRemoveFromMatchmaker(TestAdapterFactory adapterFactory)
        {
            ...
            var socket2 = Nakama.Socket.From(client2, adapterFactory());
        ...
        [Theory]
        [ClassData(typeof(WebSocketTestData))]
        public async Task ShouldPromoteMember(TestAdapterFactory adapterFactory)
        {
            var client2 = ClientUtil.FromSettingsFile();
